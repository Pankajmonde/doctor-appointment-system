...
{               ?>
                          ...
                          <!--  <p><?php  echo ($row->PageDescription);?>.</p> -->
                            <p>Welcome to Doctor appointment system, a user-friendly and efficient Doctor Appointment Management System designed to streamline the scheduling process for both healthcare providers and patients. Our platform helps doctors manage their appointments effectively, while enabling patients to easily book consultations from the comfort of their homes.

At doctor appointment system, we believe that healthcare should be accessible and well-organized. Our system eliminates the hassle of manual booking and provides a clear, structured way for doctors to manage their schedules, ensuring that both doctors and patients have a seamless experience.</p>
